...
*/
    ...
    //Testimonials gmails pop-up
    $("#gmail_director").on('click', function() {
    	alert("聯絡請洽電郵 10530201@sssh.tp.edu.tw");
    });

    $("#gmail_vicedirector").on('click', function() {
    	alert("聯絡請洽電郵 10530053@sssh.tp.edu.tw");
    });
